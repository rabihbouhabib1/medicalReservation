  ...
  <body class="custom-bg">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col col-4">
            <br>
            <h2 style="color: rgb(112, 112, 112); font-weight: Bold">Medical Reservations</h2>
        </div>
      ...
      <div class="row">
        <div class="col text-center">
          <img src="./assets/welcomeImage.png" class="img-fluid homepic" alt="index pic">
        </div>
      </div>
      <br>
      <!-- Functionalities -->
                    ...
                    <div class="row">
                      ...
                      <div class="col col-md-6">
                        <select class="form-select" aria-label="Default select example">
                          <option selected>Generalist</option>
                          <option value="1">Psychiatrist</option>
                          <option value="2">Dermathologist</option>
                        </select>
                      </div>
                    </div>
                    <br>
      ...
      <div class="col text-center">
          <!-- Button trigger modal -->
          <button type="button" class="btn btn-lg btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal2">
          Write a review
          </button>
        </div>
      </div>
